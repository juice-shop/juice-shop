  ...
  return (
    challenges
      ...
      .filter((challenge) => {
        ...
        const allTutorialChallengesSolved = tutorialChallenges.every(
        ...
        if (allTutorialChallengesSolved) {
          ...
          !allTutorialChallengesSolved &&
          challenge.tutorialOrder === null
        ) {
        ...
        const easiestDifficultyOfUnsolvedTutorialChallenges = Math.min(
          ...difficultiesOfUnsolvedTutorialChallenges,
        );

        if (
          challenge.difficulty <= easiestDifficultyOfUnsolvedTutorialChallenges
        ) {
          return true;
        }
        return false;
