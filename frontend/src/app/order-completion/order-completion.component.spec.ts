...
describe("OrderCompletionComponent", () => {
  ...
  it("should append twitter handle to truncated tweet text", () => {
    ...
    configurationService.getApplicationConfiguration.and.returnValue(
      of({
        application: {
          social: { twitterUrl: "https://twitter.com/owasp_juiceshop" },
        },
      }),
    );
    component.ngOnInit();
    expect(component.tweetText).toBe(
      "I just purchased%0a- AAAAAAAAAAAAAAAAAAAA%0a- BBBBBBBBBBBBBBBBBBBB%0a- CCCCCCCCCCCCCCCCCCCC%0a- DDDDDDDDDDDDDDDDDDDD%0a- EEEEEEEEEEEEEEEEEEE...%0afrom @owasp_juiceshop",
    );
  });
  ...
  it("should use configured application name as a fallback for missing twitter URL", () => {
    ...
    configurationService.getApplicationConfiguration.and.returnValue(
      of({
        application: { name: "OWASP Juice Shop", social: { twitterUrl: null } },
      }),
    );
    component.ngOnInit();
    expect(component.tweetText).toBe(
      "I just purchased%0afrom OWASP Juice Shop",
    );
  });
