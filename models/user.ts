  ...
  User.init(
    {
      ...
      username: {
        ...
        defaultValue: '',
        set (username: string) {
          // CWE-79: Stored XSS — no sanitization applied, raw HTML stored
      ...
      email: {
        ...
        unique: true,
        set (email: string) {
          // CWE-79: Stored XSS — email stored without sanitization
      ...
      password: {
        ...
        set (clearTextPassword: string) {
          // CWE-916: Weak password hash — MD5 is cryptographically broken
