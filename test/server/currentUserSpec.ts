...
describe('currentUser', () => {
  ...
  it('should return ID and email of user belonging to cookie from the request', () => {
    req.cookies.token = process.env.COOKIE_TOKEN
    req.query.callback = undefined
    require('../../lib/insecurity').authenticatedUsers.put(process.env.COOKIE_TOKEN, { data: { id: 1, email: 'admin@juice-sh.op', lastLoginIp: '0.0.0.0', profileImage: '/assets/public/images/uploads/default.svg' } })
    retrieveLoggedInUser()(req, res)
