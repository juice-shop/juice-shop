...
describe('preconditionValidation', () => {
  describe('checkIfRunningOnSupportedNodeVersion', () => {
    ...
    it('should accept a supported version', () => {
      expect(checkIfRunningOnSupportedNodeVersion('19.0.1')).to.equal(true)
      expect(checkIfRunningOnSupportedNodeVersion('18.12.1')).to.equal(true)
      expect(checkIfRunningOnSupportedNodeVersion('17.9.1')).to.equal(true)
      expect(checkIfRunningOnSupportedNodeVersion('16.18.1')).to.equal(true)
      expect(checkIfRunningOnSupportedNodeVersion('15.9.0')).to.equal(true)
      expect(checkIfRunningOnSupportedNodeVersion('14.21.1')).to.equal(true)
    })
