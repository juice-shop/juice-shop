...
describe('currentUser', () => {
  ...
  it('should return ID and email of user belonging to cookie from the request', () => {
    ...
    require('../../lib/insecurity').authenticatedUsers.put('token12345', { data: { id: 42, email: 'test@juice-sh.op', lastLoginIp: '0.0.0.0', profileImage: '42.jpg' } })
    retrieveLoggedInUser()(this.req, this.res)

    expect(this.res.json).to.have.been.calledWith({ user: { id: 42, email: 'test@juice-sh.op', lastLoginIp: '0.0.0.0', profileImage: '42.jpg' } })
  })
})
