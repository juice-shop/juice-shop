...
describe('easterEgg', () => {
  ...
  it('should serve /frontend/src/assets/private/threejs-demo.html', () => {
    serveEasterEgg()(this.req, this.res)

    expect(this.res.sendFile).to.have.been.calledWith(sinon.match(/frontend[/\\]src[/\\]assets[/\\]private[/\\]threejs-demo\.html/))
  })
