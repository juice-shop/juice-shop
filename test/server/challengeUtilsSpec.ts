...
describe("challengeUtils", () => {
  beforeEach(() => {
    challenges.scoreBoardChallenge = {
      id: 42,
      name: "scoreBoardChallenge",
    } as unknown as Challenge;
  });

  describe("findChallengeByName", () => {
    it("returns undefined for non-existing challenge", () => {
      expect(challengeUtils.findChallengeByName("blubbChallenge")).to.equal(
        undefined,
      );
    });
    ...
    it("returns existing challenge", () => {
      expect(
        challengeUtils.findChallengeByName("scoreBoardChallenge"),
      ).to.deep.equal({ id: 42, name: "scoreBoardChallenge" });
    });
  });
  ...
  describe("findChallengeById", () => {
    ...
    it("returns existing challenge", () => {
      expect(challengeUtils.findChallengeById(42)).to.deep.equal({
        id: 42,
        name: "scoreBoardChallenge",
      });
    });
