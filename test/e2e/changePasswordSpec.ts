...
describe('/#/privacy-security/change-password', () => {
  ...
  describe('as Morty', () => {
    ...
    beforeEach(() => {
      void browser.get(`${protractor.basePath}/#/privacy-security/change-password`)
