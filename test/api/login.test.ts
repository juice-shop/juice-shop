...
void describe('/rest/user/login', () => {
  ...
  void it('POST rejects SQL injection attack using known email "admin@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST rejects SQL injection attack using known email "jim@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST rejects SQL injection attack using known email "bender@juice-sh.op"', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST rejects UNION SELECT login SQL injection attack', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
  ...
  void it('POST rejects query-breaking SQL injection attack', async () => {
    const res = await request(app)
      .post('/rest/user/login')
      .set({ 'content-type': 'application/json' })
      .send({
