...
describe("/ftp", () => {
  ...
  it("GET the KeePass database in /ftp", () => {
    return frisby.get(URL + "/ftp/incident-support.kdbx").expect("status", 200);
  });

  it("GET the easter egg file by using Poison Null Byte attack with .pdf suffix", () => {
    return frisby
      .get(URL + "/ftp/eastere.gg%00.pdf")
      .expect("status", 200)
  ...
  it("GET the easter egg file by using Poison Null Byte attack with .md suffix", () => {
    return frisby
      .get(URL + "/ftp/eastere.gg%00.md")
      .expect("status", 200)
      .expect("bodyContains", "Congratulations, you found the easter egg!");
  });
  it("GET the SIEM signature file by using Poison Null Byte attack with .pdf suffix", () => {
    return frisby
      .get(URL + "/ftp/suspicious_errors.yml%00.pdf")
      .expect("status", 200)
      .expect(
        "bodyContains",
        "Suspicious error messages specific to the application",
      );
  });

  it("GET the SIEM signature file by using Poison Null Byte attack with .md suffix", () => {
    return frisby
      .get(URL + "/ftp/suspicious_errors.yml%00.md")
      .expect("status", 200)
      .expect(
        "bodyContains",
        "Suspicious error messages specific to the application",
  ...
  it("GET the 2013 coupon code file by using Poison Null Byte attack with .pdf suffix", () => {
    return frisby
      .get(URL + "/ftp/coupons_2013.md.bak%00.pdf")
      .expect("status", 200)
  ...
  it("GET the 2013 coupon code file by using an Poison Null Byte attack with .md suffix", () => {
    return frisby
      .get(URL + "/ftp/coupons_2013.md.bak%00.md")
      .expect("status", 200)
      .expect("bodyContains", "n<MibgC7sn");
  });
  ...
  it("GET the package.json.bak file by using Poison Null Byte attack with .pdf suffix", () => {
    return frisby
      .get(URL + "/ftp/package.json.bak%00.pdf")
      .expect("status", 200)
  ...
  it("GET the package.json.bak file by using Poison Null Byte attack with .md suffix", () => {
    return frisby
      .get(URL + "/ftp/package.json.bak%00.md")
      .expect("status", 200)
      .expect("bodyContains", '"name": "juice-shop",');
  });
  ...
  it("GET a restricted file directly from file system path on server by appending URL parameter fails with 403 error", () => {
    return frisby.get(URL + "/ftp/eastere.gg?.md").expect("status", 403);
  });

  it('GET a file whose name contains a "/" fails with a 403 error', () => {
    return frisby
      .fetch(URL + "/ftp/%2fetc%2fos-release%2500.md", {}, { urlEncode: false })
      .expect("status", 403)
      .expect(
        "bodyContains",
        "Error: File names cannot contain forward slashes!",
      );
  });
  ...
  it("GET file /ftp/quarantine/juicy_malware_linux_amd_64.url", () => {
    return frisby
      .get(URL + "/ftp/quarantine/juicy_malware_linux_amd_64.url")
      .expect("status", 200);
  });

  it("GET file /ftp/quarantine/juicy_malware_linux_arm_64.url", () => {
    return frisby
      .get(URL + "/ftp/quarantine/juicy_malware_linux_arm_64.url")
      .expect("status", 200);
  });

  it("GET existing file /ftp/quarantine/juicy_malware_macos_64.url", () => {
    return frisby
      .get(URL + "/ftp/quarantine/juicy_malware_macos_64.url")
      .expect("status", 200);
  });

  it("GET existing file /ftp/quarantine/juicy_malware_windows_64.exe.url", () => {
    return frisby
      .get(URL + "/ftp/quarantine/juicy_malware_windows_64.exe.url")
      .expect("status", 200);
  });
});
