...
describe("Server", () => {
  ...
  it("GET serves a security.txt file", () => {
    return frisby.get(URL + "/security.txt").expect("status", 200);
  });

  it("GET serves a security.txt file under well-known subfolder", () => {
    return frisby.get(URL + "/.well-known/security.txt").expect("status", 200);
  });

  it("GET serves a robots.txt file", () => {
    return frisby.get(URL + "/robots.txt").expect("status", 200);
  });

  it("GET serves a csaf provider-metadata.json", () => {
    return frisby
      .get(URL + "/.well-known/csaf/provider-metadata.json")
      .expect("status", 200);
  });
  it("GET serves a csaf index.txt", () => {
    return frisby
      .get(URL + "/.well-known/csaf/index.txt")
      .expect("status", 200);
  });
  it("GET serves a csaf changes.csv", () => {
    return frisby
      .get(URL + "/.well-known/csaf/changes.csv")
      .expect("status", 200);
  });
  it("GET serves a csaf juice-shop-sa-20200513-express-jwt.json", () => {
    return frisby
      .get(
        URL + "/.well-known/csaf/2017/juice-shop-sa-20200513-express-jwt.json",
      )
      .expect("status", 200)
...
describe("/public/images/padding", () => {
  it('GET tracking image for "Score Board" page access challenge', () => {
    return frisby
      .get(URL + "/assets/public/images/padding/1px.png")
      .expect("status", 200)
  ...
  it('GET tracking image for "Administration" page access challenge', () => {
    return frisby
      .get(URL + "/assets/public/images/padding/19px.png")
      .expect("status", 200)
      .expect("header", "content-type", "image/png");
  });
  ...
  it('GET tracking image for "Token Sale" page access challenge', () => {
    return frisby
      .get(URL + "/assets/public/images/padding/56px.png")
      .expect("status", 200)
      .expect("header", "content-type", "image/png");
  });
  ...
  it('GET tracking image for "Privacy Policy" page access challenge', () => {
    return frisby
      .get(URL + "/assets/public/images/padding/81px.png")
      .expect("status", 200)
      .expect("header", "content-type", "image/png");
  });
});
...
describe("/encryptionkeys", () => {
  ...
  it('GET a key file whose name contains a "/" fails with a 403 error', () => {
    return frisby
      .fetch(
        URL + "/encryptionkeys/%2fetc%2fos-release%2500.md",
        {},
        { urlEncode: false },
      )
      .expect("status", 403)
...
describe("Hidden URL", () => {
  ...
  it('GET Klingon translation file for "Extra Language" challenge', () => {
    return frisby
      .get(URL + "/assets/i18n/tlh_AA.json")
      .expect("status", 200)
  ...
  it('GET blueprint file for "Retrieve Blueprint" challenge', () => {
    return frisby
      .get(URL + "/assets/public/images/products/" + blueprint)
      .expect("status", 200);
  });
  ...
  it('GET folder containing access log files for "Access Log" challenge', () => {
    return frisby
      .get(URL + "/support/logs/access.log." + utils.toISO8601(new Date()))
      .expect("status", 200)
  ...
  xit("GET path traversal does not work in folder containing access log files", () => {
    return frisby
      .get(URL + "/support/logs/../../../../etc/passwd")
      .expect("status", 403);
  });
});
