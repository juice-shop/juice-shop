describe('/#/forgot-password', () => {
  ...
  describe('as Jim', () => {
    it('should be able to reset password with his security answer', () => {
      ...
      cy.get('#securityAnswer').focus().type('Samuel')
  ...
  describe('as Bender', () => {
    it('should be able to reset password with his security answer', () => {
      ...
      cy.wait('@securityQuestion')
      cy.get('#securityAnswer').focus().type("Stop'n'Drop")
      // recordings to properly fix behavior during test
  ...
  describe('as Bjoern', () => {
    describe('for his internal account', () => {
      it('should be able to reset password with his security answer', () => {
        ...
        cy.wait('@securityQuestion')
        cy.get('#securityAnswer').focus().type('West-2082')
        // recordings to properly fix behavior during test
    ...
    describe('for his OWASP account', () => {
      it('should be able to reset password with his security answer', () => {
        ...
        cy.wait('@securityQuestion')
        cy.get('#securityAnswer').focus().type('Zaya')
        // recordings to properly fix behavior during test
  ...
  describe('as Morty', () => {
    it('should be able to reset password with his security answer', () => {
      ...
      cy.wait('@securityQuestion')
      cy.get('#securityAnswer').focus().type('5N0wb41L')
      // recordings to properly fix behavior during test
  ...
  describe('as Uvogin', () => {
    it('should be able to reset password with his security answer', () => {
      ...
      cy.wait('@securityQuestion')
      cy.get('#securityAnswer').focus().type('Silence of the Lambs')
