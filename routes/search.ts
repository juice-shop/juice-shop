...
export function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query('SELECT * FROM Products WHERE ((name LIKE :like OR description LIKE :like) AND deletedAt IS NULL) ORDER BY name', { replacements: { like: likePattern } }) // vuln-code-snippet vuln-line unionSqlInjectionChallenge dbSchemaChallenge
      .then(([products]: any) => {
