...
/* jslint node: true */
export const challenges: Record<ChallengeKey, ChallengeModel> =
  {} as unknown as Record<ChallengeKey, ChallengeModel>; // this is a hack to have the challenge key non-nullable, but on init it is null.
...
export function setRetrieveBlueprintChallengeFile(
  retrieveBlueprintChallengeFileArg: string,
) {
