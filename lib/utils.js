...
exports.solve = function (challenge, isRestore) {
  ...
  models.Challenge.find(challenge.id).success(function (foundChallenge) {
    foundChallenge.updateAttributes({ solved: true }).success(function (solvedChallenge) {
...
exports.sendNotification = function (challenge, isRestore) {
  if (!this.notSolved(challenge)) {
    var flag = this.ctfFlag(challenge.name)
    var notification = {
      name: challenge.name,
