...
const validatePreconditions = async ({ exitOnFailure = true } = {}) => {
  ...
  success = checkIfRequiredFileExists('../../frontend/dist/frontend/main-es2018.js') && success
  success = checkIfRequiredFileExists('../../frontend/dist/frontend/tutorial-es2018.js') && success
  success = checkIfRequiredFileExists('../../frontend/dist/frontend/polyfills-es2018.js') && success
  success = checkIfRequiredFileExists('../../frontend/dist/frontend/runtime-es2018.js') && success
  success = checkIfRequiredFileExists('../../frontend/dist/frontend/vendor-es2018.js') && success
