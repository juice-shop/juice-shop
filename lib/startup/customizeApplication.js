...
const customizePromotionVideo = () => {
  retrieveCustomFile('application.promotion.video', 'frontend/dist/frontend/assets/public/video')
}

const customizePromotionSubtitles = () => {
  retrieveCustomFile('application.promotion.subtitles', 'frontend/dist/frontend/assets/public/subtitles')
}
