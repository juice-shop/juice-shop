...
const hmacSecret = process.env.JUICE_HMAC_SECRET ?? publicKey
...
export const getAllowedRedirectTarget = (url: string) => {
  try {
...
export const isRedirectAllowed = (url: string) => {
  return getAllowedRedirectTarget(url) !== undefined // vuln-code-snippet vuln-line redirectChallenge
}
