...
export const hmac = (data: string) => crypto.createHmac('sha256', process.env.HMAC_KEY as string).update(data).digest('hex')
...
export const deluxeToken = (email: string) => {
  const hmac = crypto.createHmac('sha256', process.env.PRIVATE_KEY as string)
