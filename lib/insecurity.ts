...
import { loadJwtKeys } from './jwtKeys'
...
const { privateKey, publicKey: verificationKey } = loadJwtKeys(process.env.JWT_PRIVATE_KEY)
export const publicKey = verificationKey
