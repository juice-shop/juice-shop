...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  /* FTP: Unauthorized users are not allowed to access FTP */
  ...
  app.use('/ftp(?!/quarantine)/:file', security.isAuthorized(), fileServer()) // vuln-code-snippet vuln-line directoryListingChallenge
  app.use('/ftp/quarantine/:file', security.isAuthorized(), quarantineServer()) // vuln-code-snippet neutral-line directoryListingChallenge
