...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  app.use('/ftp', express.static('ftp', { index: false }))// vuln-code-snippet vuln-line directoryListingChallenge
  app.use('/ftp(?!/quarantine)/:file', servePublicFiles()) // vuln-code-snippet vuln-line directoryListingChallenge
  app.use('/ftp/quarantine/:file', serveQuarantineFiles()) // vuln-code-snippet neutral-line directoryListingChallenge

  app.use('/.well-known', express.static('.well-known', { index: false }))
  app.use('/.well-known', express.static('.well-known'))

  /* /encryptionkeys directory browsing */
  app.use('/encryptionkeys', express.static('encryptionkeys', { index: false }))
  app.use('/encryptionkeys/:file', serveKeyFiles())

  /* /logs directory browsing */ // vuln-code-snippet neutral-line accessLogDisclosureChallenge
  app.use('/support/logs', express.static('logs', { index: false })) // vuln-code-snippet vuln-line accessLogDisclosureChallenge
